...
public class ListAdapterDatsale extends BaseAdapter {
    private List<Product> ProductList= new ArrayList<>();
    private Context context;

    ListAdapterDatsale(Context context, List<Product> ProductList){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        view = inflater.inflate(R.layout.show_sale_day_detail,parent,false);
