...
import static com.example.minimartv1.R.id.textAmoung;

public class ListAdapterPay extends BaseAdapter {
    private List<Product> ProductList=new ArrayList<>();
    private Context context;

    ListAdapterPay(Context context, List<Product> ProductList){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        view = inflater.inflate(R.layout.list_itemfor_pay,parent,false);
